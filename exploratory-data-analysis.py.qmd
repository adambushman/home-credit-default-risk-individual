...
bureau_history.describe()       # Get summary statistics

```

Here we learn that the bottom quartile of applications have 15 or fewer historicaly credit bureau records. This, we'd probably say, is the definition of insufficient credit history. 
