...
Looking at these results, there isn't a ideal binning of these types, but we are seeing some benefit. This would be a far better predictor that the original `ORGANIZATION_TYPE`.